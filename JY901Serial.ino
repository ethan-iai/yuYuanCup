...
void loop() 
{
 while (Serial.available()) 
  ...
  angle_back = (float)JY901.stcAngle.Angle[2]/32768*180;
  if((angle_back > -ANG &&angle_back < 0)||(angle_back > 180-ANG &&angle_back < 180)){
     //左后 -1
    digitalWrite(3,HIGH);
    digitalWrite(4,HIGH);
  }
    
  else if((angle_back > 0 &&angle_back < ANG)||(angle_back > -180 &&angle_back < -180+ANG)){
    //右后 1
    digitalWrite(3,HIGH);
    digitalWrite(4,LOW);
  }
