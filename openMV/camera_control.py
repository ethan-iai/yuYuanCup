...
class CameraAsSensor(object):
    ...
    def __init__(self, mode):
        ...
        self.thresholds = [(59, 100, 12, 127, -7, 33), # (59, 100, 3, 127, -7, 33),   (64, 94, 10, 127, -7, 40)(36, 100, 28, 127, 35, 127),     # red_LED_thresholds
                   (61, 100, -102, -29, -32, 24), # (61, 100, -102, -14, -39, 4)(36, 79, -65, -9, -13, 127) green_LED_thresholds
                   (0, 30, 0, 64, -128, 0),  # blue_LED_thresholds
                   (4, 68, 4, 80, -2, 62),  # (0, 5, 1, 19, -1, 10) red_home_thresholds
                   (9, 47, -44, -15, 4, 38)]  # (4, 47, -44, -6, 4, 38), (0, 7, -13, -9, 2, 10)]                         # green_home_thresholds
